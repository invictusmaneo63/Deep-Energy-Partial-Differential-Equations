...
def MyLossSquaredSum(tinput, target):
    #print(torch.sum((tinput - target) ** 2))
    #print(tinput)
    #print(target)
    #print(tinput.data.nelement())
...
for t in range(250):
    ...
    def closure():
        ...
        #print(bc_n2_pred.shape)
        #temp = torch.cat((torch.zeros_like(bc_n2_y),bc_n2_y))
        #print(temp.shape)
